...
namespace IIS.KANEC
{
    ...
    public class Персонал : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.KANEC.Должность fДолжность;
        ...
        [PropertyStorage(new string[] {
                "Должность"})]
        [NotNull()]
        public virtual IIS.KANEC.Должность Должность
        {
            get
            {
                ...
                IIS.KANEC.Должность result = this.fДолжность;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПерсоналE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПерсоналE", typeof(IIS.KANEC.Персонал));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПерсоналL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПерсоналL", typeof(IIS.KANEC.Персонал));
                }
            }
        }
    }
