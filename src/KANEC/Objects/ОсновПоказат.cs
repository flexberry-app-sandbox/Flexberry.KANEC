...
namespace IIS.KANEC
{
    ...
    [MasterViewDefineAttribute("ОсновПоказатE", "Маркетолог", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "")]
    ...
    public class ОсновПоказат : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОсновПоказатE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОсновПоказатE", typeof(IIS.KANEC.ОсновПоказат));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОсновПоказатL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОсновПоказатL", typeof(IIS.KANEC.ОсновПоказат));
                }
            }
        }
    }
